...
DATA_DIR = Path("datasets/species")
...
SPECIES_CLASSES = [
    "Asiatic_Lion", "Bengal_Tiger", "Gharial", "Golden_Jackal",
    "Great_Indian_Bustard", "Himalayan_Monal", "Indian_Elephant",
    "Indian_Gazelle", "Indian_Peafowl", "Indian_Rhinoceros",
    "Indian_Rock_Python", "Indian_Wolf", "King_Cobra", "Mugger_Crocodile",
    "Nilgiri_Tahr", "Sambar_Deer", "Sloth_Bear", "Snow_Leopard",
    "Spotted_Deer", "Wild_Boar",
]
